...
<section id="main" class="container main-content mt-5 content">
	<div class="row">
		...
		<div class="box-category">
			...
			<div class="post-inner clearfix">
				<img src="<?php echo base_url('l-content/uploads/empty.jpg')?>" class="rounded mx-auto d-block" width="390">
			</div>
			<?php else: ?>
			<div class="post-inner clearfix">
