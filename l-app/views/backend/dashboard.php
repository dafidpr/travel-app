			...
			<div class="logo">
				<a href="#" class="logo-img">
					<span class="desktop-logo text-logo" >
						<img src="<?=content_url('uploads/travel-logo.png');?>" style="width:180px">
					</span>
					<img class="small-logo" src="<?=content_url('uploads/icon-travel.png');?>" alt="" />
				</a>			
					...
					<div class="navbar-header">
						<div class="navbar-brand">
							<ul class="list-inline">
								...
								<li class="list-inline-item"><a href="#" class="hidden-md hidden-lg mg-r-15"><img class="small-logo" src="<?=content_url('uploads/icon-travel.png');?>" alt="Logo"></a></li>
