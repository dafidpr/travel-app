...
class Bandara_model extends CI_Model {
	...
	private $_table = 't_bandara';
	private $_column_order = array(null, 't_bandara.id', 't_bandara.iata', 't_bandara.icao', 't_kota.nama_kota', 't_bandara.kelas', 't_bandara.kategori', 't_bandara.nama_bandara', null);
	private $_column_search = array( 't_bandara.id', 't_bandara.iata', 't_bandara.icao', 't_kota.nama_kota', 't_bandara.kelas', 't_bandara.kategori', 't_bandara.nama_bandara');
	...
	private function _all_bandara()
	{
		$this->db->select('t_bandara.id, t_bandara.nama_bandara, t_bandara.iata, t_bandara.icao, t_kota.nama_kota, t_bandara.kelas, t_bandara.kategori');
		$this->db->from($this->_table);
		$this->db->join('t_kota', 't_kota.id = t_bandara.kota_id');
		// $this->db->where('id >',1);
	...
	public function get_bandara($id=0) 
	{
		$result = NULL;
